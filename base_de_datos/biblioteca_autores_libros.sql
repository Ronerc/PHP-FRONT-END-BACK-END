...
CREATE TABLE `autores_libros` (
  ...
  CONSTRAINT `autores_libros_ibfk_1` FOREIGN KEY (`autores_id`) REFERENCES `autores` (`id`) ON DELETE CASCADE,
  CONSTRAINT `autores_libros_ibfk_2` FOREIGN KEY (`libros_id`) REFERENCES `libros` (`id`) ON DELETE CASCADE
