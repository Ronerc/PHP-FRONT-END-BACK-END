...
CREATE TABLE `categorias_libros` (
  ...
  PRIMARY KEY (`categorias_id`,`libros_id`),
  KEY `libros_id` (`libros_id`),
  CONSTRAINT `categorias_libros_ibfk_1` FOREIGN KEY (`categorias_id`) REFERENCES `categorias` (`id`) ON DELETE CASCADE,
  CONSTRAINT `categorias_libros_ibfk_2` FOREIGN KEY (`libros_id`) REFERENCES `libros` (`id`) ON DELETE CASCADE
